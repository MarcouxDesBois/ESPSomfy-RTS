...
class Somfy {
    ...
    pinMaps = [
        { name: '', maxPins: 39, inputs: [0, 6, 7, 8, 9, 10, 11, 37, 38], outputs: [6, 7, 8, 9, 10, 11, 34, 35, 36, 37, 38, 39] },
    ...
    loadPins(type, sel, opt) {
        ...
        let pm = this.pinMaps.find(x => x.name === cm) || { name: '', maxPins: 39, inputs: [0, 6, 7, 8, 9, 10, 11, 37, 38], outputs: [6, 7, 8, 9, 10, 11, 34, 35, 36, 37, 38, 39] };
